...
import icu.dreamripples.aero_suite.client.ConvenientAnalogTransmissionVisual;
...
import icu.dreamripples.aero_suite.network.AddressingSignScrollPayload;
...
import icu.dreamripples.aero_suite.client.SequentialFeederScreen;
import icu.dreamripples.aero_suite.client.ModPartialModels;
import icu.dreamripples.aero_suite.client.RedstoneCounterweightVisual;
import icu.dreamripples.aero_suite.client.RedstoneCounterweightLightVisual;
import icu.dreamripples.aero_suite.client.StabilizerRenderer;
import icu.dreamripples.aero_suite.client.AddressingSignRenderer;
import icu.dreamripples.aero_suite.client.WorldAnchorRenderer;
...
public class AeronauticsGravityClient {
    ...
    public static void onMouseScroll(InputEvent.MouseScrollingEvent event) {
        ...
        mc.getConnection().send(new AddressingSignScrollPayload(pos, next));
