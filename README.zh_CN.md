...
手持 **火花魔杖(Spark Wand)** 右键 contraption,可叠加显示每个方块的质量数字与质心十字准星。
...
一个红石-旋转转换器。根据 0–15 的红石信号从查找表输出**固定 RPM**,忽略输入转速。信号为 0 时表现为离合器(脱开);一种用红石驱动 contraption 的紧凑方式。
